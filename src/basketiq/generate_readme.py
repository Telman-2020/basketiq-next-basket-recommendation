...
def generate_readme() -> None:
    """
    Generate the BasketIQ README.md file.

    Run from the project root:

        python generate_readme.py

    Or place this file under src/basketiq and adjust README_FILE if needed.
    """
    readme = """# BasketIQ: Next-Basket Recommendation with ML and Local LLM Analysis
...
"""
    ...
    print(f"README generated at: {README_FILE.resolve()}")
